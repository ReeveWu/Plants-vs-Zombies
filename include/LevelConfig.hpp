...
inline const std::array<LevelConfig, 15>& GetAllLevels() {
    static const std::array<LevelConfig, 15> levels = {{
        ...
        {5, {1, 2, 3, 4}, 15, 4, 0, 1, 600, 0, {{0.75f, 7}}, 5},
        // Level  5: 5 lanes, +mine
        {5, {1, 2, 3, 4, 5}, 15, 5, 1, 0, 600, 0, {}, 6},
        // Level  6: 5 lanes, +iceshooter
        {5, {1, 2, 3, 4, 5, 6}, 15, 8, 2, 0, 540, 0, {}, 7},
        // Level  7: 5 lanes, +chomper, 2 waves
        {5, {1, 2, 3, 4, 5, 6, 7}, 20, 10, 3, 2, 540, 0,
         {{0.50f, 8}, {0.85f, 8}}, 8},
        // Level  8: all plants, fast spawn
        {5, {1, 2, 3, 4, 5, 6, 7, 8}, 20, 10, 5, 0, 480, 0, {}, 0},
        // Level  9: 2 waves
